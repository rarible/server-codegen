# OpenAPI Generator for the rarible-server library
...
The `RaribleServerGenerator.java` has comments in it--lots of comments.  There is no good substitute
for reading the code more, though.  See how the `RaribleServerGenerator` implements `CodegenConfig`.
